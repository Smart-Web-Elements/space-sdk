...
final class Checklists extends AbstractApi
{
     ...
     */
    final public function createChecklist(array $project, array $data, array $response = []): array
    {
     ...
     * @deprecated This method is deprecated since 2022-04-08. Use POST on projects/{project}/documents
     */
    final public function importChecklist(array $project, array $data, array $response = []): array
    {
     ...
     * @throws MissingArgumentException
     */
    final public function importChecklistLines(array $project, string $checklistId, array $data): void
    {
     ...
     */
    final public function getAllChecklists(array $project, array $request = [], array $response = []): array
    {
        $uri = 'projects/{project}/planning/checklists';
        $uriArguments = [
            'project' => $project,
     ...
     */
    final public function updateChecklist(array $project, string $checklistId, array $data = []): void
    {
     ...
     */
    final public function deleteChecklist(array $project, string $checklistId): void
    {
        $uri = 'projects/{project}/planning/checklists/{checklistId}';
        $uriArguments = [
            'project' => $project,
