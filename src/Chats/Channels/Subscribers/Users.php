...
class Users extends AbstractApi
{
     ...
     */
    public function addUsersToChannel(string $channel, array $data): void
    {
        $uri = 'chats/channels/{channel}/subscribers/users';
        $required = [
            'profiles' => self::TYPE_ARRAY,
        ];
     ...
     * @throws MissingArgumentException
     */
    public function listUsersSubscribedToChannel(string $channel, array $request, array $response = []): array
    {
        $uri = 'chats/channels/{channel}/subscribers/users';
        $required = [
     ...
     * @throws MissingArgumentException
     */
    public function removeUsersFromChannel(string $channel, array $request): void
    {
        $uri = 'chats/channels/{channel}/subscribers/users';
        $required = [
            'profiles' => self::TYPE_ARRAY,
